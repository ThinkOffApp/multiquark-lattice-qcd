...
*Caption: Main admin dashboard view with live phase/progress bars and per-thread cursor monitoring for concurrent SU(2) production workers.*

![SU(2) physical-comparison and diagnostics view](images/dashboard/physical_comparison_live.png)
*Caption: Physical-comparison diagnostics view captured from a production run on a MacBook M4 Pro after approximately 15 hours of continuous runtime.*
...
- P. Pennanen, A. M. Green, C. Michael, *Four-quark flux distribution and binding in lattice SU(2)* — [hep-lat/9804004](https://arxiv.org/abs/hep-lat/9804004)
- P. Pennanen, A. M. Green, C. Michael, *An interquark potential model for multi-quark systems* — [hep-lat/9804003](https://arxiv.org/abs/hep-lat/9804003)
...
- N. Ishii, S. Aoki, T. Hatsuda, *Nuclear force from lattice QCD* — [nucl-th/0611096](https://arxiv.org/abs/nucl-th/0611096)
